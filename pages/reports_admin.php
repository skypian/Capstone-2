...
<div class="flex min-h-screen">
  <aside class="w-64 bg-white border-r">
    ...
    <nav class="mt-6">
      ...
      <a href="reports_admin.php" class="flex items-center px-6 py-3 text-maroon bg-red-50 border-r-4 border-maroon">Reports</a>
  ...
  <main class="flex-1">
    <header class="bg-white border-b px-6 py-4">
      ...
      <p class="text-gray-600">Generate allocation/utilization reports by fiscal year.</p>
    </header>
    <section class="p-6">
      <div class="bg-white border rounded-xl p-6">
        <p class="text-gray-600">Stub page. Add filters and export (PDF/CSV) here.</p>
      </div>
    </section>
  </main>
</div>
