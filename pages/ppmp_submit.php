...
<title>Department • Submit PPMP</title>
...
<div class="flex min-h-screen">
  <aside class="w-64 bg-white border-r">
    ...
    <nav class="mt-6">
      ...
      <a href="ppmp_submit.php" class="flex items-center px-6 py-3 text-maroon bg-red-50 border-r-4 border-maroon">Submit PPMP</a>
  ...
  <main class="flex-1">
    <header class="bg-white border-b px-6 py-4">
      <h1 class="text-2xl font-bold text-gray-900">Submit PPMP</h1>
      <p class="text-gray-600">Submit Project Procurement Management Plan.</p>
    </header>
    <section class="p-6">
      <div class="bg-white border rounded-xl p-6">
        <p class="text-gray-600">Stub page. Add PPMP submission form here.</p>
      </div>
    </section>
  </main>
</div>
