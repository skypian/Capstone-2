...
<title>Department • Track Requests</title>
...
<div class="flex min-h-screen">
  <aside class="w-64 bg-white border-r">
    ...
    <nav class="mt-6">
      ...
      <a href="track_requests.php" class="flex items-center px-6 py-3 text-maroon bg-red-50 border-r-4 border-maroon">Track Requests</a>
  ...
  <main class="flex-1">
    <header class="bg-white border-b px-6 py-4">
      <h1 class="text-2xl font-bold text-gray-900">Track Requests</h1>
      <p class="text-gray-600">Monitor PPMP/LIB/PR statuses across workflow stages.</p>
    </header>
    <section class="p-6">
      <div class="bg-white border rounded-xl p-6">
        <p class="text-gray-600">Stub page. Add request list and statuses here.</p>
      </div>
    </section>
  </main>
</div>
