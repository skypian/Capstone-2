...
<div class="flex min-h-screen">
  <aside class="w-64 bg-white border-r">
    ...
    <nav class="mt-6">
      ...
      <a href="notifications.php" class="flex items-center px-6 py-3 text-maroon bg-red-50 border-r-4 border-maroon">Notifications</a>
  ...
  <main class="flex-1">
    <header class="bg-white border-b px-6 py-4">
      ...
      <p class="text-gray-600">System notifications and alerts.</p>
    </header>
    <section class="p-6">
